...
for each in range(10):
    ...
    theList = np.random.choice(9999999999, theInput)
    print(theList)
    ...
    print('pythonsort done')

    selectionSort(selectionList)
    print('selectionsort done')
...
# # Pull data from csv
mycsv = csv.reader(open('newTestingDoc.csv'))
next(mycsv)
insertionValuesList = []
selectionValuesList = []
pythonValuesList = []
